...
uniqueGameIds <- unique(weekly_data_clean[["gameId"]])

selectInput(inputId = "gameId", label = "Game to Analyze:",
            choices = uniqueGameIds)
...
plotly::renderPlotly({
     plot_game_involvement <-
         homeTeam_df() %>%
         pivot_longer(cols = c(goal_contributions, not_goal_contributions), names_to = "GC", values_to = "Number") %>%
